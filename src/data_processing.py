...
class DataProcessing:
    def __init__(self,train_data_path, test_data_path, feature_store : RedisFeatureStore):
        ...
        logger.info("Your Data Processing Is initialised......")
    ...
    def handle_imbalanced_data(self):
        try:
            ...
            logger.error(f"Error while handling inbalanced data {e}")
            raise CustomException(str(e))
    ...
    def retreive_feature_redis_store(self, entity_id) : 
    ...
    def run(self):
        try:
            ...
            logger.info("End of Pipeline of Data processing")
...
if __name__=="__main__":
    ...
    print(data_processor.retreive_feature_redis_store(entity_id=332))